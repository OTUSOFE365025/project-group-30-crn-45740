...
The Web Application architecture also supports an external database, which is needed for R6. 
However, one modification that must be made is to add a cache for offline or low connectivity (RS14). |
